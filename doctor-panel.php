...
if (isset($_SESSION['dname'])) {
    ...
    echo "<script>alert('Doctor name is not set. Please log in again.');</script>";
...
if (isset($_GET['cancel']) && isset($_GET['ID'])) {
    ...
    if ($query) {
        ...
        echo "<script>alert('Failed to cancel the appointment.');</script>";
    }
}
?>
<html lang="en">
...
.text-primary {
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    JOIN 
        appointmenttb 
    ON 
        prestb.ID = appointmenttb.ID
    WHERE 
        prestb.doctor = '$doctor';
";
                  ...
                  ?>
                      <tr>
                        ...
                        <!-- <td> <button class="btn btn-danger">Send</button> -->
                        <td>
                        <button 
    class="btn btn-danger" 
    data-toggle="modal" 
    data-target="#emailModal" 
    onclick="fillEmail('<?php echo $row['email']; ?>')">Send</button>
